...
/**
 * The left edge stripe. It used to be the ONLY thing telling the two card types
 * apart at a glance — an airmail weave on a parcel card against a solid gold
 * bar on an announcement — and with announcements gone every card wears the
 * weave. Kept because it is the board's mark: the scalloped stamp seam, the
 * ticket perforation and the navy stub that preceded it are all gone, and this
 * is what is left of the airmail look.
 */
const AIRMAIL_WEAVE =

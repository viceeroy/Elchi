...
export const translations: Record<Locale, Translations> = {
  uz: {
    ...
    metaDescription: "Yo'lovchilar va jo'natma yubormoqchi bo'lganlar uchun bepul e'lon taxtasi. Chamadoningizda bo'sh joyni e'lon qiling yoki yo'lovchi orqali jo'natma yuboring.",
    ...
    fabTravelerLabel: "Yo'lovchi",
    fabRequestLabel: "Jo'natma",

...
export const translations: Record<Locale, Translations> = {
  ...
  ru: {
    ...
    fabTravelerLabel: "Я лечу",
    fabRequestLabel: "Посылка",
    ...
    noteTitle: "Простая заметка",
    noteSubtitle: "Коротко расскажите о своей услуге или предложении.",
    noteThemeLabel: "Тема (необязательно)",
    noteThemePlaceholder: "Например: услуга доставки грузов",
    noteTextLabel: "Текст",
    noteTextPlaceholder: "Например: еженедельная доставка грузов Сеул — Ташкент.",
    noteContactLabel: "Контакт (необязательно)",
    noteSubmitBtn: "Разместить заметку",
    noteAutoDeleteLabel: "Заметка удалится автоматически через 30 дней.",
    errorFieldNoteText: "Напишите текст заметки",
    toastNoteCreated: "Заметка размещена!",
  },
  en: {
    ...
    fabCloseLabel: "Close",
    fabTravelerLabel: "I am flying",
    fabRequestLabel: "Parcel",
    fabNoteLabel: "Note",
    feedTabParcelLabel: "Parcels",
    feedTabNotesLabel: "Notes",
    announcementTag: "Note",
    announcementBodyLabel: "Text",
    noteTitle: "Simple note",
    noteSubtitle: "Say briefly what you offer.",
    noteThemeLabel: "Theme (optional)",
    noteThemePlaceholder: "e.g. Cargo delivery service",
    noteTextLabel: "Text",
    noteTextPlaceholder: "e.g. Weekly cargo runs, Seoul to Tashkent.",
    noteContactLabel: "Contact (optional)",
    noteSubmitBtn: "Post the note",
    noteAutoDeleteLabel: "The note expires automatically after 30 days.",
    errorFieldNoteText: "Write the note's text",
    toastNoteCreated: "Note posted!",
  }
};
